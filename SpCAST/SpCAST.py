...
class SpCAST(nn.Module):
    def __init__(self, input_dim, latent_dim1, latent_dim2, 
                 num_classes, noise_scale=0.2, num=5,
                 device=None):
        ...
        self.classifier = nn.Sequential(
            nn.Linear(latent_dim2, num_classes, bias=False),
        )
    ...
    def forward(self, x):
        ...
        combined_class = self.classifier(combined)
        reconstruct = self.decoder(combined)
        
        return combined, combined_class, reconstruct